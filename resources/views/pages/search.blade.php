  ...
  <header>
    ...
    <div id="toggle-icon" onclick="toggleMobileMenu(this)">
      ...
      <div class="flex-container">
        ...
        <h1 class="text-center">Create your A2S job seeker account</h1>
        ...
        <div class="container"> 
          <div class="row" style="padding: 20px;">
              ...
              <div id="talent-signup-form-container" class="col-md-5" style="background-color: #003865; border-radius: 20px; padding: 20px; height: 90%;">
                <div class="flex-container">
                  <h3 class="text-center" style="color: #D9D9D9; margin: 5px;">Find your dream job.<h3> 

                  <h3 class="text-center" style="color: #D9D9D9;"> Sign up NOW!</h3>
                   
                  <div class="mt-4" id="talent-form-signup">
                    <form action="login_talent.html">
                    ...
                    <!-- <form action="">
                            ...
                            <input class="form-control" type="text" required placeholder="First name" style="margin-bottom: 10px;">
                            <br>
                            <input class="form-control " type="text" required placeholder="Last name" style="margin-bottom: 10px;">
                                                    <br>
                          
                            <input class="form-control " type="email" required placeholder="Email" style="margin-bottom: 10px;">
                            <br>
                            
                              <input class="form-control " type="password" required placeholder="Enter password" style="margin-bottom: 10px;">
                              <br>
                              <input class="form-control " type="password" required placeholder="Confirm password" style="margin-bottom: 10px;">
                          <!-- </div> -->
                          <!-- <br>
                          <div class="d-flex justify-content-center">
                            <button id="buttonbox signup-talent-btn" class="greenbutton regular" style="margin-left: 5%;">Create account</button>
                          </div> -->
                    <!-- </form> --> -->
                  </div>    
                </div>
              ...
              <!-- end of first column -->
              <div class="col-md-7">
                <img class="img-fluid" id="hero-signup-form"  src="images/jobseeker-sign-up-form.svg" alt="" style="opacity: 80%; border-radius: 20px; margin-left: 10px;">
              </div>
